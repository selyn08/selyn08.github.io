...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: "Consulting & Accompagnement", href: "#consulting" },
    { name: "SELYN Suite (Super App SaaS)", href: "#suite" },
    { name: "Espace Coworking", href: "#coworking" },
    { name: "Nos Offres & Tarifs", href: "#pricing" },
    { name: "Communauté & Réseautage", href: "#community" },
